...
#include "StdAfx.h"
#include "BikeSpeedDisplayDummy.h"
#include <windows.h>
#include <stdio.h>
#include <string>
#include <tchar.h>
...
/**************************************************************************
 * BikeSpeedDisplayDummy::InitializeSim
 * 
 ...
 *
 **************************************************************************/
void BikeSpeedDisplayDummy::InitializeSim()
{
...
/**************************************************************************
 * BikeSpeedDisplayDummy::HandleReceive
 * 
 ...
 *
 **************************************************************************/
void BikeSpeedDisplayDummy::HandleReceive(UCHAR* pucRxBuffer_)
{
...
/**************************************************************************
 * BikeSpeedDisplayDummy::UpdateDisplay
 * 
 ...
 *
 **************************************************************************/
void BikeSpeedDisplayDummy::UpdateDisplay(UCHAR ucPageNum_)
{	
	// Display basic data
...
/**************************************************************************
 * BikeSpeedDisplayDummy::numericUpDown_Sim_WheelCircumference_ValueChanged
 * 
 ...
 *
 **************************************************************************/
System::Void BikeSpeedDisplayDummy::numericUpDown_Sim_WheelCircumference_ValueChanged(System::Object^  sender, System::EventArgs^  e) 
{
