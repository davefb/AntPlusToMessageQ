...
#pragma region Windows Form Designer generated code
	...
	void InitializeComponent(void)
	{
		...
		this->listBox_P2Battery->Items->AddRange(gcnew cli::array< System::Object^  >(4) {
			L"00 - OK New", L"01 - OK Good", L"10 - OK",
				L"11 - Low"
		});
		...
		this->listBox_P2Location->Items->AddRange(gcnew cli::array< System::Object^  >(4) {
			L"00 - Laces", L"01 - Midsole", L"10 - Chest",
				L"11 - Other"
		});
		...
		this->Load += gcnew System::EventHandler(this, &SDMDisplay::SDMDisplay_Load);
...
private: System::Void SDMDisplay_Load(System::Object^  sender, System::EventArgs^  e) {
}
};