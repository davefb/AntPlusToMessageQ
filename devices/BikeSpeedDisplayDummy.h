...
public ref class BikeSpeedDisplayDummy : public System::Windows::Forms::Form, public ISimBase{
public:
	BikeSpeedDisplayDummy(){
		InitializeComponent();
		InitializeSim();			
	}
...
#pragma region Windows Form Designer generated code
	...
	void InitializeComponent(void)
	{
		...
		this->numericUpDown_Sim_WheelCircumference->ValueChanged += gcnew System::EventHandler(this, &BikeSpeedDisplayDummy::numericUpDown_Sim_WheelCircumference_ValueChanged);
		// 
		// groupBox2
		// 
